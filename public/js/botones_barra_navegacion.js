...
links.forEach((item) => {
    item.addEventListener('click', function (){
        if (window.location.href.indexOf('producto') !== -1 || window.location.href.indexOf('contacto') !== -1){
            window.location.href = "http://localhost:8000/?to="+item.getAttribute("data-link");
